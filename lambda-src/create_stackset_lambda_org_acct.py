...
def launch_crwd_discover(templateUrl, paramList, cList, stacketsetName):
...
def lambda_handler(event, context):
    try:
        ...
        #
        CrowdstrikeTemplateUrl = f'https://' + S3Bucket + '.s3.' + AwsRegion + \
                                 '.amazonaws.com/ct_crowdstrike_stackset_org_acct.yaml'
        ...
        if event['RequestType'] in ['Create']:
            ...
            keyDict['ParameterKey'] = 'S3Bucket'
            keyDict['ParameterValue'] = S3Bucket
            CRWD_Discover_paramList.append(dict(keyDict))
